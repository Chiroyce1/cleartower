...
Source: https://github.com/kewonit/aeris/blob/main/src/lib/atc-feeds.ts
*/
...
function feed(
	...
	return {
		...
		type,
		mountPoint,
		streamUrl: `https://d.liveatc.net/${mountPoint}`,
	};
}
...
export const ATC_FEEDS: Record<string, AtcFeed[]> = {
	...
	TQPF: [feed("TQPF", "tower", "Tower", "", "tncs_tqpf_twr")],
	...
	MYLD: [
		...
		feedN("MYLD", "center", "Emergency/Guard", "", "myld1_guard", "2"),
		feedN("MYLD", "center", "MYLD/MYLS CTAF", "", "myld1_ctaf", "3"),
	],

	// Exuma International Airport (Exuma, Bahamas) - CSV verified
	MYEF: [feed("MYEF", "tower", "Tower/CTAF", "", "myld1_twr")],

	// -- Barbados --
	// Grantley Adams International Airport (Bridgetown, Barbados) - CSV verified
	TBPB: [feed("TBPB", "combined", "Gnd/Twr/Radar/Center", "", "tbpb")],
	...
	CYYG: [feed("CYYG", "combined", "Twr/App/Dep", "", "cyyg2")],
	...
	CYEG: [
		...
		feed(
			"CYEG",
			"center",
			"CZEG Edmonton Center (FL280/below)",
			"",
			"czeg_yeg_1",
		),
		feedN(
	...
	CYFC: [feed("CYFC", "combined", "Ground/Tower", "", "cyfc2")],

	// Gander International Airport (Gander, Newfoundland, Canada) - CSV verified
	CYQX: [feed("CYQX", "combined", "Ground/Tower", "", "cyqx1_gnd_twr")],
	...
	CYYR: [
		...
		feedN("CYYR", "combined", "Del/Gnd/Twr/App #2", "", "cyyr2", "2"),
		feedN("CYYR", "combined", "Del/Gnd/Twr/App/Center", "", "cyyr_s", "3"),
	],
	...
	CYAW: [
		...
		feedN("CYAW", "combined", "Gnd/Twr/Ops", "", "cyaw", "2"),
	],
	...
	CYFB: [
		...
		feedN("CYFB", "center", "Montreal Center", "", "cyfb_zul", "2"),
		feedN("CYFB", "center", "RDO/FIC/Edmonton Ctr", "", "cyfb_rdo", "3"),
	],
	...
	CYXU: [
		...
		feedN("CYXU", "tower", "Tower 119.4", "", "cyxu1_twr_119400", "2"),
		feedN("CYXU", "tower", "Tower 125.65", "", "cyxu1_twr_125650", "3"),
	...
	CYHU: [feed("CYHU", "tower", "Tower", "", "cyhu")],

	// Montreal-Mirabel International Airport (Montreal, Quebec, Canada) - CSV verified
	CYMX: [feed("CYMX", "combined", "Gnd/Twr/Radio", "", "cymx2")],
	...
	CYOW: [feed("CYOW", "combined", "Gnd/Twr/App", "", "cyow3")],

	// Ottawa/Rockcliffe Airport (Ottawa, Ontario, Canada) - CSV verified
	CYRO: [
		feed("CYRO", "center", "Area Guard", "", "cyro1_guard"),
		feedN("CYRO", "center", "CTAF", "", "cyro1_ctaf", "2"),
		feedN("CYRO", "center", "Gatineau Radio", "", "cyro1_radio", "ne"),
	],
	...
	CYPQ: [
		...
		feedN("CYPQ", "center", "UNICOM/Guard", "", "cypq6_unicom", "2"),
	],

	// Pitt Meadows Airport (Pitt Meadows, British Columbia, Canada) - CSV verified
	CYPK: [feed("CYPK", "tower", "Tower", "", "cypk2")],
	...
	CYQB: [
		...
		feedN("CYQB", "atis", "ATIS (French)", "", "cyqb1_atis_fr", "french"),
	...
	CYXE: [
		...
		feedN("CYXE", "combined", "Gnd/Twr", "", "cyxe2_twr", "2"),
	],
	...
	CYSC: [
		...
		feedN("CYSC", "center", "Emergency/Guard", "", "cysc1_guard", "2"),
		feed("CYSC", "combined", "RCO/GCO", "", "cysc1_rco"),
		feedN("CYSC", "combined", "ZUL 132.55", "", "cysc1_zul_132550", "2"),
		feedN(
			"CYSC",
			"combined",
			"ZUL 133.225",
	...
	CYJN: [feed("CYJN", "combined", "Ground/Tower", "", "cyjn")],
	...
	CYQI: [
		...
		feedN("CYQI", "center", "Halifax FIC", "", "cyqi5", "2"),
		feedN(
			"CYQI",
			"center",
	...
	MMLP: [feed("MMLP", "combined", "Twr/App", "", "mmlp")],
	...
	MMBT: [feed("MMBT", "tower", "Twr/Center", "", "mmbt_misc")],
	...
	MMTC: [feed("MMTC", "combined", "Twr/App/Center #1", "", "mmtc")],
	...
	TNCS: [feed("TNCS", "tower", "Info/TFFJ Twr", "", "tncs2")],
	...
	KABQ: [
		...
		feedN("KABQ", "tower", "Tower #2", "", "kabq2_twr2", "2"),
		feed("KABQ", "ground", "Del/Gnd", "", "kabq2_1"),
		feed("KABQ", "approach", "App/Dep (Main)", "", "kabq2_3"),
		feedN("KABQ", "approach", "App/Dep (Other)", "", "kabq2_4", "other"),
	...
	KIKV: [feed("KIKV", "ground", "Del/CTAF", "", "kikv2")],
	...
	KAVL: [
		...
		feedN("KAVL", "combined", "Gnd/Twr/App", "", "kavl2", "2"),
	],
	...
	KASE: [
		...
		feedN("KASE", "combined", "Ground/Tower", "", "kase2_gnd_twr", "se"),
	],
	...
	KACY: [
		...
		feedN("KACY", "ground", "Ground", "", "kacy_a_gnd", "2"),
		feed("KACY", "approach", "App/Dep", "", "kacy_a_app"),
		feed("KACY", "atis", "ATIS", "", "kacy_a_atis"),
		feed("KACY", "combined", "GIANT KILLER", "", "kacy_gk"),
		feedN("KACY", "combined", "Ground/Tower", "", "kacy_a_gnd_twr", "2"),
		feedN("KACY", "combined", "ZDC SIE54/CASINO51", "", "kacy_zdc_sie", "3"),
		feedN(
			"KACY",
			"combined",
			"ZNY ATL86/ZDC SIE54",
	...
	KAUO: [
		...
		feedN("KAUO", "combined", "Gnd/Twr/CTAF #2", "", "kauo1_gnd_twr2", "2"),
	],
	...
	KBWI: [
		...
		feedN("KBWI", "ground", "Ground", "", "kbwi_es_gnd", "2"),
		feed(
			"KBWI",
			"approach",
			"Potomac Approach (GRACO Sector) #1",
			"",
			"kbwi_es_app_124550",
		),
		feedN(
	...
	KBED: [
		...
		feedN("KBED", "ground", "Del/Gnd", "", "kbed1_del_gnd", "2"),
		feedN("KBED", "ground", "Ground", "", "kbed1_gnd", "3"),
		...
		feedN("KBED", "atis", "ATIS #2", "", "kbed_murp_atis2", "2"),
	...
	KVBT: [feed("KVBT", "combined", "KROG/KXNA/KVBT/Misc", "", "krog")],
	...
	KBVY: [
		...
		feedN("KBVY", "tower", "Tower #2", "", "kbvy_twr2", "2"),
	...
	KBGM: [
		...
		feedN("KBGM", "center", "ZNY Sector 36 Sparta Low", "", "kbgm1_zny36", "3"),
		feedN(
			"KBGM",
			"center",
	...
	KBHM: [feed("KBHM", "combined", "Del/Gnd/Twr/App", "", "kbhm")],
	...
	KBCT: [
		...
		feed(
			"KBCT",
			"approach",
			"Palm Beach Approach/Departure (BCT)",
			"",
			"kbct1_dep",
		),
	...
	KBZN: [
		...
		feedN("KBZN", "center", "ZLC Sector 06 (BZN)", "", "kbzn1_zlc", "bzn"),
		feed("KBZN", "combined", "Area Flight Service", "", "kbzn1_rdo"),
		feedN("KBZN", "combined", "Gnd/Twr", "", "kbzn1_gnd_twr", "2"),
		feedN("KBZN", "combined", "Gnd/Twr/App", "", "kbzn1_gta", "3"),
	],

	// Bremerton National Airport (Bremerton, Washington, United States) - CSV verified
	KPWT: [feed("KPWT", "center", "CTAF", "", "kpwt")],
	...
	KBXM: [feed("KBXM", "atis", "CTAF/AWOS", "", "kbxm2")],
	...
	KBUF: [feed("KBUF", "combined", "Gnd/Twr/App", "", "kbuf1_dgta")],
	...
	KBUR: [
		...
		feed(
			"KBUR",
			"approach",
			"SOCAL Approach (Moorpark Sector) #1",
			"",
			"kbur3_gnd_twr_128_750",
		),
		feedN(
			"KBUR",
			"approach",
	...
	KCHO: [
		...
		feedN("KCHO", "center", "ZDC Sector 01/02/05", "", "kcho3_zdc_125", "se"),
		feedN("KCHO", "center", "ZDC Sector 2", "", "kcho3_zdc_133200", "2"),
		feedN("KCHO", "center", "ZDC Sector 30/72", "", "kcho3_zdc_127925", "3"),
		feedN("KCHO", "center", "ZDC Sector 37", "", "kcho3_zdc_133025", "4"),
		feedN("KCHO", "center", "ZDC Sector 60 #2", "", "kcho3_zdc_121675", "5"),
	],

	// Chatham Municipal Airport (Chatham, Massachusetts, United States) - CSV verified
	KCQX: [feed("KCQX", "center", "5B6/KCQX/KPVC CTAF", "", "khya2_122800")],

	// Lovell Field Airport (Chattanooga, Tennessee, United States) - CSV verified
	KCHA: [feed("KCHA", "combined", "Twr/App", "", "kcha2")],
	...
	KCKB: [
		...
		feedN("KCKB", "approach", "App/Dep (East)", "", "kckb_app_east", "east"),
		feedN("KCKB", "approach", "App/Dep (West)", "", "kckb_app_west", "west"),
	...
	KCLW: [feed("KCLW", "center", "CTAF", "", "kpie1_kclw_ctaf")],

	// Heritage Field Airport (Coatesville, Pennsylvania, United States) - CSV verified
	KPTW: [feed("KPTW", "center", "CTAF", "", "kptw3_ctaf")],
	...
	KCOE: [
		...
		feedN("KCOE", "center", "FSS", "", "kcoe2_fss", "2"),
		feedN(
			"KCOE",
			"center",
	...
	KDAB: [
		...
		feedN("KDAB", "tower", "Tower (118.1) #2", "", "kdab_twr_sec", "2"),
		feedN("KDAB", "tower", "Tower (120.7) #1", "", "kdab_twr_pri_radio", "1"),
		feedN("KDAB", "tower", "Tower (120.7) #2", "", "kdab_twr_pri", "3"),
		feedN("KDAB", "tower", "Tower (Both)", "", "kdab_twr", "both"),
		feed("KDAB", "ground", "Clearance Delivery", "", "kdab_del"),
		feedN("KDAB", "ground", "Clearance/Ground", "", "kdab_del_gnd", "2"),
		feedN("KDAB", "ground", "Ground", "", "kdab_gnd_121900", "3"),
	...
	KDED: [
		...
		feedN("KDED", "center", "CTAF/Misc", "", "kded2", "2"),
		feedN("KDED", "center", "Emergency/Guard", "", "kded_guard", "3"),
	],

	// Deadhorse Airport (Deadhorse, Alaska, United States) - CSV verified
	PASC: [feed("PASC", "center", "CTAF/Unicom/AFIS/App", "", "pasc")],
	...
	KAPA: [
		...
		feedN("KAPA", "tower", "Tower (Secondary #2)", "", "kapa2_twr3", "se"),
	...
	KDOV: [
		...
		feedN("KDOV", "combined", "ZDC19/53 Kenton/Woodstown", "", "kdov_zdc", "2"),
	],

	// Dubuque Regional Airport (Dubuque, Iowa, United States) - CSV verified
	KDBQ: [
		feed("KDBQ", "center", "ZAU Sector 63 #2", "", "zau_dbq_63"),
		feedN("KDBQ", "center", "ZAU Sector 75 #2", "", "zau_dbq_75", "se"),
		feedN("KDBQ", "center", "ZAU Sector 75/76", "", "zau_dbq_75_76", "2"),
		feedN("KDBQ", "center", "ZAU Sector 76 #2", "", "zau_dbq_76", "3"),
	],
	...
	KELP: [
		...
		feedN("KELP", "approach", "Approach", "", "kelp1_app_e", "2"),
	...
	KPAE: [feed("KPAE", "combined", "Ground/Tower", "", "kpae")],
	...
	KCQF: [feed("KCQF", "center", "CTAF/Misc", "", "kcqf")],
	...
	KFLO: [feed("KFLO", "combined", "Gnd/Twr/App", "", "kflo2")],
	...
	KRSW: [feed("KRSW", "combined", "Gnd/Twr/App/Dep", "", "krsw2")],
	...
	KFSM: [feed("KFSM", "combined", "Gnd/Twr/App", "", "kfsm1")],
	...
	KVKX: [
		...
		feedN("KVKX", "center", "Area Guard", "", "kvkx1_guard", "2"),
		feedN("KVKX", "center", "CTAF", "", "kvkx1_ctaf", "3"),
		feedN("KVKX", "center", "CTAF", "", "kvkx1_ctaf", "4"),
	],

	// Gainesville Regional Airport (Gainesville, Florida, United States) - CSV verified
	KGNV: [feed("KGNV", "combined", "Ground/Tower", "", "kgnv")],

	// Montgomery County Airpark (Gaithersburg, Maryland, United States) - CSV verified
	KGAI: [feed("KGAI", "center", "CTAF/UNICOM", "", "kgai")],
	...
	KGED: [
		...
		feedN("KGED", "center", "Emergency/Guard", "", "kged2_guard", "2"),
	],

	// Georgetown County Airport (Georgetown, South Carolina, United States) - CSV verified
	KGGE: [feed("KGGE", "center", "CTAF", "", "kgge2")],
	...
	KGFL: [feed("KGFL", "center", "Area CTAF", "", "kgfl1_ctaf")],
	...
	KGFK: [
		...
		feedN("KGFK", "tower", "Tower 1 (118.4/IFR/VFR)", "", "kgfk3_twr1", "2"),
	...
	KGRR: [
		...
		feedN("KGRR", "ground", "Ground", "", "kgrr2_2_gnd", "2"),
		feed("KGRR", "approach", "App/Dep", "", "kgrr2_2_app"),
		feedN("KGRR", "approach", "App/Dep (South)", "", "kgrr2_2_app_s", "south"),
		feed("KGRR", "center", "Emergency/Guard", "", "kgrr2_2_guard"),
		feedN("KGRR", "center", "ZAU Sector 22", "", "kgrr2_2_zau22", "se"),
		feedN("KGRR", "center", "ZAU Sector 25", "", "kgrr2_2_zau25", "2"),
		feed("KGRR", "combined", "Del/Gnd/Twr", "", "kgrr2_2_del_gnd_twr"),
		feedN("KGRR", "combined", "Gnd/Twr/App", "", "kgrr2_2_gnd_twr_app", "2"),
	],
	...
	KGSO: [
		...
		feedN("KGSO", "center", "ZTL Sector 29/33", "", "kgso1_ztl2933", "se"),
		feedN("KGSO", "center", "ZTL Sector 33", "", "kgso1_ztl33", "2"),
	],
	...
	KPGV: [feed("KPGV", "center", "CTAF", "", "kpgv")],
	...
	KGSP: [
		...
		feedN("KGSP", "approach", "App/Dep (West)", "", "kgmu_kgsp_app_w", "west"),
	...
	KHWO: [
		...
		feedN("KHWO", "tower", "Tower (Primary) #1", "", "khwo2_twr1", "primary"),
		feedN(
			"KHWO",
			"tower",
			"Tower (Secondary) #1",
	...
	PHJR: [feed("PHJR", "atis", "ATIS", "", "phnl1_phjr_atis")],
	...
	KHUT: [feed("KHUT", "combined", "Ground/Twr", "", "khut")],
	...
	KINL: [
		...
		feedN("KINL", "center", "Princeton Radio FSS", "", "kinl1_radio", "2"),
		feedN("KINL", "center", "KINL/CYAG CTAF", "", "kinl1_ctaf", "3"),
	],

	// Inverness Airport (Inverness, Florida, United States) - CSV verified
	KINF: [feed("KINF", "center", "CTAF", "", "kinf2")],

	// Iowa City Municipal Airport (Iowa City, Iowa, United States) - CSV verified
	KIOW: [feed("KIOW", "combined", "KCID Gnd/Twr/App/KIOW", "", "kcid")],
	...
	KJAN: [feed("KJAN", "combined", "Gnd/Twr/App/Dep", "", "kjan")],
	...
	KJAQ: [
		...
		feedN("KJAQ", "center", "Guard", "", "kjaq2_guard", "2"),
	],

	// Jackson County Airport-Reynolds Field (Jackson, Michigan, United States) - CSV verified
	KJXN: [feed("KJXN", "combined", "Gnd/Twr/UNICOM", "", "kjxn2_twrgnd")],
	...
	KCRG: [
		...
		feedN("KCRG", "center", "UNICOM", "", "kcrg1_unicom", "2"),
	...
	KAFN: [feed("KAFN", "center", "MA/NH CTAF 122.8", "", "kmht_murp_122800")],
	...
	PHOG: [
		...
		feedN("PHOG", "ground", "Ground", "", "phog2_gnd", "2"),
		...
		feedN("PHOG", "center", "HCF Center (PHOG/All)", "", "phog2_hcf", "phog"),
		feed("PHOG", "combined", "Del/Gnd/Twr/App", "", "phog2"),
		feedN("PHOG", "combined", "HCF App (N/S)", "", "phog2_app", "2"),
		feedN("PHOG", "combined", "HCF App (North)", "", "phog2_app_n", "north"),
		feedN("PHOG", "combined", "HCF App (South)", "", "phog2_app_s", "south"),
	],
	...
	KMCI: [
		...
		feedN("KMCI", "combined", "Del/Gnd/Twr/App", "", "kmci1", "2"),
	],
	...
	KLSE: [
		...
		feed(
			"KLSE",
			"center",
			"Minneapolis Center (Sector 05 LSE Area)",
			"",
			"klse2_zmp_128600",
		),
	],
	...
	KNEL: [feed("KNEL", "combined", "KNEL/KWRI/ZNY", "", "kblm1")],

	// Lakeland Linder International Airport (Lakeland, Florida, United States) - CSV verified
	KLAL: [
		feed("KLAL", "tower", "Tower", "", "klal_twr"),
		feedN("KLAL", "tower", "Tower (North)", "", "klal_twr_north", "north"),
		feedN("KLAL", "tower", "Tower (North/South)", "", "klal_twr_ns", "south"),
		feedN("KLAL", "tower", "Tower (South)", "", "klal_twr_south", "2"),
	...
	KLAN: [feed("KLAN", "combined", "Del/Gnd/Twr/App", "", "klan")],
	...
	KLAS: [
		...
		feedN("KLAS", "tower", "Tower (Rwys 01/19)", "", "klas4_twr_0119", "rwys"),
		feedN("KLAS", "tower", "Tower (Rwys 08/26)", "", "klas4_twr_0826", "08"),
		feed("KLAS", "ground", "Clearance Delivery", "", "klas4_del"),
		feedN("KLAS", "ground", "Ground (East)", "", "klas4_gnd_e", "east"),
		feedN("KLAS", "ground", "Ground (East/West)", "", "klas4_gnd", "west"),
		feedN("KLAS", "ground", "Ground (West)", "", "klas4_gnd_w", "2"),
		feedN("KLAS", "ground", "Ramp Control", "", "klas4_ramp", "3"),
		feed("KLAS", "approach", "Approach (Final)", "", "klas5_app_final"),
		feedN("KLAS", "approach", "Approach (NE)", "", "klas4_app_ne", "ne"),
		feedN("KLAS", "approach", "Approach (NW)", "", "klas4_app_nw", "nw"),
		feedN("KLAS", "approach", "Approach (SE)", "", "klas4_app_se", "se"),
		feedN("KLAS", "approach", "Approach (SW)", "", "klas4_app_sw", "sw"),
		feedN("KLAS", "approach", "Approach (VFR)", "", "klas4_app_vfr", "vfr"),
		...
		feedN("KLAS", "center", "ZLA Sector 34 (High)", "", "klas5_zla34", "high"),
	],

	// North Las Vegas Airport (Las Vegas, Nevada, United States) - CSV verified
	KVGT: [feed("KVGT", "tower", "Tower", "", "klas4_kvgt_twr")],
	...
	KLWM: [
		...
		feedN("KLWM", "ground", "Ground", "", "klwm_gnd", "2"),
	...
	KJYO: [
		...
		feedN("KJYO", "center", "ZDC Sectors 04", "", "kiad2_8", "se"),
		feedN("KJYO", "center", "ZDC Sectors 12", "", "kiad2_5", "2"),
	],
	...
	KIPJ: [feed("KIPJ", "ground", "CTAF/Del", "", "kipj")],

	// Mission Field Airport (Livingston, Montana, United States) - CSV verified
	KLVM: [feed("KLVM", "center", "CTAF", "", "kbzn1_123000")],
	...
	KLGB: [
		...
		feedN("KLGB", "ground", "Ground", "", "klgb_gnd", "2"),
	],
	...
	KLKU: [
		...
		feedN("KLKU", "center", "Emergency/Guard", "", "klku2_guard", "2"),
	...
	KLHZ: [feed("KLHZ", "center", "CTAF", "", "klhz")],
	...
	KHEF: [feed("KHEF", "combined", "Del/Gnd/Twr", "", "khef")],
	...
	KMLB: [
		...
		feedN("KMLB", "tower", "Tower (North)", "", "kmlb1_twr_n", "north"),
		feedN("KMLB", "tower", "Tower (South)", "", "kmlb1_twr_s", "south"),
		...
		feedN("KMLB", "combined", "Tower/Approach", "", "kmlb1_twr_app", "2"),
	],

	// Memphis International Airport (Memphis, Tennessee, United States) - CSV verified
	KMEM: [feed("KMEM", "combined", "Gnd/Twr/App/Dep", "", "kmem4_test")],

	// Falcon Field Airport (Mesa, Arizona, United States) - CSV verified
	KFFZ: [
		feed("KFFZ", "tower", "Twr (North)", "", "kffz_twr_n"),
		feedN("KFFZ", "tower", "Twr (South)/CTAF", "", "kffz_twr_s", "south"),
		feedN("KFFZ", "tower", "Twr #1", "", "kffz_twr_b", "1"),
	...
	KTMB: [
		...
		feedN("KTMB", "tower", "Tower (North)", "", "ktmb1_twr2", "north"),
	...
	KANE: [feed("KANE", "tower", "Twr/CTAF", "", "kane")],
	...
	KMOR: [feed("KMOR", "center", "CTAF/App", "", "kmor2")],
	...
	KMYR: [
		...
		feedN("KMYR", "combined", "Gnd/Twr/App (UHF)", "", "kmyr_mil", "uhf"),
	],

	// Nampa Municipal Airport (Nampa, Idaho, United States) - CSV verified
	KMAN: [feed("KMAN", "center", "CTAF", "", "kman2_ctaf")],
	...
	KASH: [
		...
		feedN("KASH", "tower", "Tower #2", "", "kash4_twr", "2"),
		feedN("KASH", "tower", "Tower #3", "", "kmht_murp_kash_twr", "3"),
		feed("KASH", "ground", "Ground", "", "kash1_gnd"),
		feedN("KASH", "ground", "Ground/FBO #1", "", "kash1_gnd_fbo", "1"),
		feedN("KASH", "ground", "Ground/FBO #2", "", "kash4_gnd", "2"),
		feed("KASH", "approach", "Boston App/Dep (MHT) #1", "", "kmht_app"),
		feed("KASH", "atis", "ATIS #1", "", "kash1_atis"),
		feedN("KASH", "atis", "ATIS #2", "", "kash_atis", "2"),
		feedN("KASH", "atis", "ATIS #3", "", "kash_murp_atis2", "3"),
		feed("KASH", "combined", "Gnd/Twr/FBO #1", "", "kash1_gnd_twr"),
		feedN("KASH", "combined", "Gnd/Twr/FBO #2", "", "kash4_gnd_twr", "2"),
	],
	...
	KBNA: [
		...
		feedN("KBNA", "approach", "App/Dep (East)", "", "kbna_app_east", "east"),
		feedN("KBNA", "approach", "App/Dep (West)", "", "kbna_app_west", "west"),
		feedN(
			"KBNA",
			"approach",
			"Approach (Final)",
		...
		feed(
			"KBNA",
			"center",
			"Nashville Area Helicopter CTAF (BNA)",
			"",
			"kbna_heli",
		),
	...
	KJWN: [
		...
		feed(
			"KJWN",
			"center",
			"Nashville Area Helicopter CTAF (JWN)",
			"",
			"kjwn1_heli",
		),
	...
	KORF: [
		...
		feedN("KORF", "combined", "Gnd/Twr/App/Radar", "", "korf1", "2"),
	],
	...
	KOFF: [feed("KOFF", "combined", "Tower/Approach", "", "koff3_twr_app")],

	// Orange Municipal Airport (Orange, Massachusetts, United States) - CSV verified
	KORE: [feed("KORE", "center", "MA/NH CTAF 122.8", "", "kmht_murp_122800")],
	...
	KSFB: [
		...
		feedN("KSFB", "tower", "Tower (Main)", "", "ksfb3_twr1", "main"),
		feedN("KSFB", "tower", "Tower (South)", "", "ksfb3_twr2", "south"),
		feed("KSFB", "ground", "Clearance Delivery", "", "ksfb4_del"),
		feedN("KSFB", "ground", "Del/Gnd", "", "ksfb4_s", "2"),
		feedN("KSFB", "ground", "Ground", "", "ksfb4_gnd", "3"),
		feed(
			"KSFB",
			"approach",
			"KMCO App/Dep (North Satellite)",
	...
	KOSH: [
		...
		feedN("KOSH", "tower", "North Tower (09/27) #1", "", "kosh", "09"),
		feedN("KOSH", "tower", "North Tower (09/27) #2", "", "kosh_s_twr1", "27"),
		feedN("KOSH", "tower", "South Tower (18/36) #1", "", "kosh2", "18"),
		feedN("KOSH", "tower", "South Tower (18/36) #2", "", "kosh_s_twr2", "36"),
		feedN(
			"KOSH",
			"tower",
			"Tower (North+South) #1",
		...
		feedN("KOSH", "approach", "Fisk VFR Approach #2", "", "kosh_s_fisk", "2"),
		feedN("KOSH", "approach", "Fisk VFR Approach #4", "", "kosh_n_fisk3", "4"),
		...
		feedN("KOSH", "departure", "Departure Monitor #2", "", "kosh_depmon", "2"),
		feed("KOSH", "atis", "ATIS", "", "kosh6"),
		feed("KOSH", "center", "Emergency/Guard", "", "kosh_guard"),
		feedN("KOSH", "center", "Green Bay Radio", "", "kosh_gbr", "2"),
		feedN(
			"KOSH",
			"center",
		...
		feedN("KOSH", "combined", "Gnd/Twr/App #1", "", "kosh_perm", "1"),
		feedN("KOSH", "combined", "Milwaukee App (OSH) #1", "", "kosh8", "osh"),
		feedN(
			"KOSH",
			"combined",
	...
	KOTM: [feed("KOTM", "combined", "Del/Twr/App/Center", "", "kotm")],
	...
	KSFZ: [
		...
		feedN("KSFZ", "center", "CTAF", "", "ksfz2", "2"),
	],

	// Penn Yan Airport (Penn Yan, New York, United States) - CSV verified
	KPEO: [feed("KPEO", "center", "CTAF", "", "kpeo2")],
	...
	KDVT: [
		...
		feedN("KDVT", "tower", "Tower (North)", "", "kdvt3_twr2", "north"),
		feedN("KDVT", "tower", "Tower (South)", "", "kdvt3_twr1", "south"),
		feed("KDVT", "ground", "Clearance Delivery", "", "kdvt3_del"),
		feedN("KDVT", "ground", "Delivery/Ground", "", "kdvt3_del_gnd", "2"),
		feedN("KDVT", "ground", "Ground", "", "kdvt3_gnd", "3"),
	...
	KIWA: [
		...
		feedN("KIWA", "ground", "Ground", "", "kiwa1_gnd", "2"),
		feed(
			"KIWA",
			"approach",
			"KPHX Approach (Pima/Willy Sectors)",
	...
	KPCM: [feed("KPCM", "center", "KPCM/KGIF CTAF", "", "klal8_ctaf_123050")],
	...
	TJPS: [
		...
		feedN("TJPS", "center", "CTAF", "", "tjps1_ctaf", "2"),
	],
	...
	KPTK: [
		...
		feedN("KPTK", "approach", "Del/Gnd/App", "", "kptk1_del_gnd", "2"),
	...
	KPRC: [
		...
		feedN("KPRC", "center", "ZAB Sector 43", "", "kprc1_zab_128450", "se"),
		feedN("KPRC", "center", "ZAB Sector 45", "", "kprc1_zab_127675", "2"),
		feedN("KPRC", "center", "ZAB Sector 92", "", "kprc1_zab_135325", "3"),
		feed("KPRC", "combined", "Ground/Tower", "", "kprc1_gnd_twr"),
		feedN("KPRC", "combined", "Practice Area", "", "kprc1_pa", "2"),
	],

	// Northern Maine Regional Airport at Presque Isle (Presque Isle, Maine, United States) - CSV verified
	KPQI: [feed("KPQI", "combined", "KHUL/KPQI/ZBW01/15", "", "khul")],

	// Fillmore County Airport (Preston, Minnesota, United States) - CSV verified
	KFKA: [feed("KFKA", "center", "CTAF", "", "kfka")],

	// Provincetown Municipal Airport (Provincetown, Massachusetts, United States) - CSV verified
	KPVC: [feed("KPVC", "center", "5B6/KCQX/KPVC CTAF", "", "khya2_122800")],

	// Provo Municipal Airport (Provo, Utah, United States) - CSV verified
	KPVU: [feed("KPVU", "tower", "Tower", "", "kpvu2")],
	...
	KPLU: [feed("KPLU", "approach", "Del/CTAF/App", "", "kplu2")],
	...
	KRDU: [
		...
		feedN("KRDU", "approach", "Approach/Departure", "", "krdu_app2", "2"),
	...
	KRNO: [
		...
		feedN("KRNO", "ground", "Ground", "", "krno1_gnd", "2"),
		...
		feedN("KRNO", "combined", "Del/Gnd/Twr/App/ZOA", "", "krno", "2"),
	],
	...
	KOFP: [feed("KOFP", "center", "CTAF", "", "kofp2_ctaf")],
	...
	KROA: [
		...
		feedN("KROA", "ground", "Del/Gnd", "", "kroa_del_gnd", "2"),
		feedN("KROA", "ground", "Ground", "", "kroa_gnd", "3"),
		...
		feedN("KROA", "approach", "App/Dep #1", "", "kroa2_app", "1"),
		feedN("KROA", "approach", "App/Dep #2", "", "kroa_app", "3"),
		feedN("KROA", "approach", "App/Dep #3", "", "kroa4_app", "4"),
		feed("KROA", "atis", "ATIS", "", "kroa_atis"),
		feed("KROA", "combined", "Gnd/Twr #1", "", "kroa2_twr"),
		feedN("KROA", "combined", "Gnd/Twr #2", "", "kroa4_gnd_twr", "2"),
		feedN("KROA", "combined", "Gnd/Twr/App #1", "", "kroa2", "1"),
		feedN("KROA", "combined", "Gnd/Twr/App #2", "", "kroa4_gnd_twr_app", "3"),
	],

	// Skyhaven Airport (Rochester, New Hampshire, United States) - CSV verified
	KDAW: [feed("KDAW", "center", "KCON/KDAW/KFIT CTAF", "", "kmht_murp_122700")],
	...
	KROG: [feed("KROG", "combined", "KROG/KXNA/KVBT/Misc", "", "krog")],
	...
	KSNA: [
		...
		feed(
			"KSNA",
			"departure",
			"SOCAL Departure (Pacific Sector)",
			"",
			"ksna1_dep_128100",
		),
	...
	KSAF: [feed("KSAF", "tower", "Tower", "", "ksaf")],
	...
	KMQY: [
		...
		feedN("KMQY", "ground", "Ground", "", "kmqy1_gnd", "2"),
	...
	KSKA: [feed("KSKA", "tower", "Tower", "", "kska2")],
	...
	KSUA: [feed("KSUA", "combined", "Ground/Tower", "", "ksua1")],

	// Summerville Airport (Summerville, South Carolina, United States) - CSV verified
	KDYB: [feed("KDYB", "center", "CTAF", "", "kdyb2")],
	...
	KTPF: [feed("KTPF", "center", "CTAF", "", "ktpa5_ktpf_ctaf")],

	// Tampa Executive Airport (Tampa, Florida, United States) - CSV verified
	KVDF: [feed("KVDF", "center", "CTAF", "", "ktpa5_kvdf_ctaf")],

	// Teterboro Airport (Teterboro, New Jersey, United States) - CSV verified
	KTEB: [
		feed("KTEB", "tower", "Tower (Secondary)", "", "kteb_es_twr2"),
		feedN("KTEB", "tower", "Tower #1", "", "kteb_es_twr_r", "1"),
		feedN("KTEB", "tower", "Tower #2", "", "kteb_es_twr", "2"),
		feed("KTEB", "ground", "Clearance Delivery #1", "", "kteb_es_del"),
		feedN("KTEB", "ground", "Clearance Delivery #2", "", "kteb_es_del_r", "2"),
		feedN("KTEB", "ground", "Del/Gnd/Ramp", "", "kteb1", "3"),
		feedN("KTEB", "ground", "Ground #1", "", "kteb_es_gnd_r", "1"),
		feedN("KTEB", "ground", "Ground #2", "", "kteb_es_gnd", "4"),
		feedN("KTEB", "ground", "Ramp Control", "", "kteb_es_ramp", "5"),
		feed("KTEB", "atis", "ATIS", "", "kteb_es_atis"),
		feed("KTEB", "combined", "FBOs", "", "kteb_es_fbos"),
		feedN("KTEB", "combined", "Ops", "", "kteb_es_ops", "2"),
	],

	// Ocean County Airport (Toms River, New Jersey, United States) - CSV verified
	KMJX: [feed("KMJX", "combined", "KBLM/N12/3N6/KMJX", "", "kblm2")],

	// Topeka Regional Airport (Topeka, Kansas, United States) - CSV verified
	KFOE: [feed("KFOE", "combined", "Gnd/Twr/CTAF", "", "ktop3")],

	// Philip Billard Municipal Airport (Topeka, Kansas, United States) - CSV verified
	KTOP: [feed("KTOP", "combined", "Ground/Tower", "", "ktop2_twrgnd")],

	// Cherry Capital Airport (Traverse City, Michigan, United States) - CSV verified
	KTVC: [feed("KTVC", "combined", "Ground/Tower/Center", "", "ktvc2_all")],
	...
	KVRB: [
		...
		feedN("KVRB", "center", "ZMA Sector 23", "", "kvrb_zma23", "se"),
	],

	// Martha\'s Vineyard Airport (Vineyard Haven, Massachusetts, United States) - CSV verified
	KMVY: [feed("KMVY", "combined", "Twr/App", "", "kmvy_twrapp")],
	...
	KNTU: [
		...
		feedN("KNTU", "combined", "Gnd/Twr/App", "", "kntu3_uhf", "2"),
		feedN("KNTU", "combined", "Gnd/Twr/App/Radar", "", "kntu1", "3"),
	],

	// Walnut Ridge Regional Airport (Walnut Ridge, Arkansas, United States) - CSV verified
	KARG: [feed("KARG", "center", "CTAF/Memphis Center", "", "karg1")],
	...
	KDCA: [
		...
		feedN("KDCA", "tower", "Tower/KJPN Helicopter", "", "kdca4_heli", "2"),
		...
		feedN("KDCA", "combined", "Tower/Approach", "", "kdca", "2"),
	],
	...
	KJPN: [
		...
		feedN("KJPN", "tower", "KDCA Tower/KJPN Helicopter", "", "kdca4_heli", "2"),
	],

	// Waukesha County Airport (Waukesha, Wisconsin, United States) - CSV verified
	KUES: [feed("KUES", "combined", "Gnd/Twr", "", "kues4")],

	// Waupaca Municipal Airport (Waupaca, Wisconsin, United States) - CSV verified
	KPCZ: [feed("KPCZ", "center", "KPCZ/KCLI/Y50/W23/KEZS CTAF", "", "kpcz2")],
	...
	KPBI: [
		...
		feedN("KPBI", "ground", "Ground", "", "kpbi2_gnd", "2"),
		feed("KPBI", "approach", "App (Final)", "", "kpbi2_final"),
		feed("KPBI", "atis", "ATIS", "", "kpbi2_atis"),
		feed("KPBI", "center", "Emergency/Guard", "", "kpbi2_guard"),
		feedN("KPBI", "center", "ZMA Sector 01", "", "kpbi1_zma01", "se"),
		feedN("KPBI", "center", "ZMA Sector 20", "", "kpbi1_zma20", "2"),
		feedN("KPBI", "center", "ZMA Sector 21", "", "kpbi1_zma21", "3"),
		feedN("KPBI", "center", "ZMA Sector 46", "", "kpbi1_zma46", "4"),
		feed("KPBI", "combined", "App (North)", "", "kpbi2_app_n"),
		feedN("KPBI", "combined", "App (North/South)", "", "kpbi2_app", "north"),
		feedN("KPBI", "combined", "App (South)", "", "kpbi2_app_s", "south"),
		feedN("KPBI", "combined", "Dep (North)", "", "kpbi2_dep_n", "2"),
		feedN("KPBI", "combined", "Dep (North/South)", "", "kpbi2_dep", "3"),
		feedN("KPBI", "combined", "Dep (South)", "", "kpbi2_dep_s", "4"),
		feedN("KPBI", "combined", "GA Gate Hold", "", "kpbi2_gate_ga", "5"),
		feedN("KPBI", "combined", "Gnd/Twr", "", "kpbi2_gnd_twr", "6"),
	],
	...
	KDMW: [
		...
		feedN("KDMW", "center", "Emergency/Guard #2", "", "kdmw2_guard", "2"),
	],
	...
	KXWA: [
		...
		feedN("KXWA", "center", "CTAF", "", "kxwa2_ctaf", "2"),
	],
	...
	KILM: [
		...
		feedN("KILM", "center", "ZNY Sector 83 HANRI", "", "zny_ilm_hanri", "se"),
		feed("KILM", "combined", "Gnd/Twr/App", "", "kilm2_gnd_twr_app"),
		feedN("KILM", "combined", "Gnd/Twr/App/ZDC", "", "kilm2_s", "2"),
	],
	...
	KGIF: [
		...
		feedN("KGIF", "center", "GCO/Guard", "", "kgif_gco_guard", "2"),
		feedN("KGIF", "center", "KGIF/F57 CTAF", "", "kgif_ctaf", "3"),
		feedN("KGIF", "center", "KPCM/KGIF CTAF", "", "klal8_ctaf_123050", "4"),
	],
	...
	KWRI: [feed("KWRI", "combined", "KNEL/KWRI/ZNY", "", "kblm1")],
	...
	KNYL: [feed("KNYL", "combined", "Del/Gnd/Twr/App/ZLA", "", "knyl1_local")],
	...
	EINN: [
		...
		feedN("EINN", "center", "Shannon Control Low", "", "einn2_low1", "2"),
	...
	EVRA: [
		...
		feedN("EVRA", "center", "FIC", "", "evra4", "2"),
	],

	// -- Lithuania --
	// Vilnius International Airport (Vilnius, Lithuania) - CSV verified
	EYVI: [feed("EYVI", "combined", "Tower/Approach/Misc", "", "eyvi")],
	...
	EHEH: [
		...
		feedN("EHEH", "tower", "Tower #2", "", "eheh7_twr2", "2"),
		feedN("EHEH", "tower", "Tower 122.1", "", "eheh7_twr1", "3"),
	...
	EHLE: [
		...
		feedN("EHLE", "approach", "App/Dep", "", "ehle_app", "2"),
	...
	EHRD: [
		...
		feedN("EHRD", "atis", "Rotterdam ATIS", "", "ehrd1_atis", "2"),
	],
	...
	LWSK: [
		...
		feedN("LWSK", "center", "ACC (Upper)", "", "lwsk2_1", "upper"),
	],

	// -- Norway --
	// Alesund Airport, Vigra (Alesund, Norway) - CSV verified
	ENAL: [feed("ENAL", "tower", "Tower", "", "enal4")],

	// Alta Airport (Alta, Norway) - CSV verified
	ENAT: [feed("ENAT", "combined", "Twr/App/Control", "", "enat2")],
	...
	ENEV: [feed("ENEV", "combined", "Twr/App/ACC", "", "enev")],

	// Farsund Airport, Lista (Farsund, Norway) - CSV verified
	ENLI: [
		feed("ENLI", "center", "CTAF", "", "enli3_ctaf"),
		feedN("ENLI", "center", "Polaris FIR Sector 09/12", "", "enli3_pol9", "se"),
		feedN("ENLI", "center", "Polaris FIR Sector 10/11", "", "enli3_pol10", "2"),
		feed("ENLI", "combined", "GA", "", "enli3_ga"),
	],

	// Kirkenes Airport (Kirkenes, Norway) - CSV verified
	ENKR: [feed("ENKR", "combined", "ENKR/ENVD Twr/App", "", "enkr2")],

	// Kristiansand Airport - Kjevik (Kristiansand, Norway) - CSV verified
	ENCN: [feed("ENCN", "combined", "Tower/Approach", "", "encn")],

	// Tromso Airport (Langnes, Norway) - CSV verified
	ENTC: [feed("ENTC", "combined", "Tower/Approach", "", "entc")],
	...
	ENTO: [
		...
		feedN("ENTO", "combined", "Twr/App", "", "ento_twr_tma", "2"),
	],

	// Stavanger Sola Airport (Stavanger, Norway) - CSV verified
	ENZV: [feed("ENZV", "combined", "Gnd/Twr/App", "", "enzv2")],

	// Vaernes Airport (Trondheim, Norway) - CSV verified
	ENVA: [feed("ENVA", "combined", "Ground/Tower/Approach", "", "enva")],

	// Vadso Airport (Vadso, Norway) - CSV verified
	ENVD: [feed("ENVD", "combined", "ENKR/ENVD Twr/App", "", "enkr2")],
	...
	EPWA: [
		...
		feedN("EPWA", "approach", "Approach #2", "", "epwa_app2", "2"),
	],
	...
	EPWR: [
		...
		feedN("EPWR", "center", "FIS (South)", "", "epwr4_fis_s", "south"),
	],
	...
	LPMA: [
		...
		feedN("LPMA", "approach", "Approach/LPPC Center", "", "lppc2", "2"),
	],

	// Porto Airport (Porto, Portugal) - CSV verified
	LPPR: [feed("LPPR", "approach", "Approach #1", "", "lppr2")],

	// -- Romania --
	// Brasov-Ghimbav International Airport (Brasov, Romania) - CSV verified
	LRBV: [feed("LRBV", "tower", "Tower", "", "lrbv2")],
	...
	LJMB: [feed("LJMB", "tower", "Tower", "", "ljmb3")],

	// -- Sweden --
	// Dala Airport (Borlange, Sweden) - CSV verified
	ESSD: [feed("ESSD", "tower", "Tower/Control", "", "essd2")],
	...
	RJOO: [feed("RJOO", "tower", "Tower", "", "rjoo1")],
	...
	RJSF: [feed("RJSF", "combined", "RDO", "", "rjsf")],
	...
	OKKK: [feed("OKKK", "combined", "Gnd/Twr/App/Radar", "", "okbk2")],

	// -- Malaysia --
	// Kota Kinabalu International Airport (Kota Kinabalu, Malaysia) - CSV verified
	WBKK: [feed("WBKK", "combined", "Ground/Tower/Radar/Control", "", "wbkk2")],

	// Butterworth Airport (Panang, Malaysia) - CSV verified
	WMKB: [feed("WMKB", "tower", "Tower", "", "wmkb")],
	...
	UHHH: [feed("UHHH", "combined", "Gnd/Twr/App/Radar/Control", "", "uhhh2")],
	...
	USTR: [feed("USTR", "combined", "Gnd/Twr/App", "", "ustr")],

	// -- Taiwan --
	// Taipei Songshan Airport (Taipei, Taiwan) - CSV verified
	RCSS: [feed("RCSS", "combined", "Tower/Approach/Departure", "", "rcss2")],
	...
	YSCB: [
		...
		feedN("YSCB", "approach", "App/Dep (East)", "", "yscb2_app_e", "east"),
		feedN("YSCB", "approach", "App/Dep (West)", "", "yscb2_app_w", "west"),
	...
	YBCV: [feed("YBCV", "center", "CTAF/Brisbane Center", "", "ybcv")],

	// Darwin International Airport (Darwin, Northern Territory, Australia) - CSV verified
	YPDN: [feed("YPDN", "combined", "Gnd/Twr/App/Dep", "", "ypdn")],
	...
	YBTL: [
		...
		feedN("YBTL", "ground", "Ground", "", "ybtl1_gnd", "2"),
	...
	YBWW: [feed("YBWW", "center", "CTAF", "", "ybww_ctaf")],
	...
	MROC: [
		feed(
			"MROC",
			"combined",
			"Delivery/Ground/Tower/Approach/Center/Misc",
			"",
			"mroc",
		),
	],
	...
	SPST: [feed("SPST", "tower", "Tower", "", "spst2")],

	// -- Suriname --
	// Zorg en Hoop Airport (Paramaribo, Suriname) - CSV verified
	SMZO: [feed("SMZO", "tower", "Tower", "", "smzo2")],
	...
	TTCP: [feed("TTCP", "combined", "Gnd/Twr/App", "", "ttcp2")],

	// -- Uruguay --
	// Santa Bernardina International Airport (Durazno, Uruguay) - CSV verified
	SUDU: [feed("SUDU", "combined", "Twr/App/FIR", "", "sudu1_twr_app")],
	...
	FMMI: [feed("FMMI", "combined", "Twr/App/Center", "", "fmmi")],

	// -- Reunion --
	// Rolland Garros Airport (Sainte-Marie, Reunion) - CSV verified
	FMEE: [feed("FMEE", "approach", "Approach/Departure", "", "fmee3")],

	// -- Zambia --
	// Kenneth Kaunda International Airport (Lusaka, Zambia) - CSV verified
	FLKK: [feed("FLKK", "combined", "Twr/App", "", "flkk2")],
};
